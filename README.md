...
- Установите и настройте HAProxy, воспользуйтесь материалами к лекции по 
- Настройте балансировку Round-robin на 4 уровне.
- На проверку направьте конфигурационный файл haproxy, скриншоты, где видно перенаправление запросов на разные серверы при обращении к HAProxy.
### *Решение:*
#### Конфигурационный файл haproxy: [haproxy-hw-1.cfg] (https://github.com/EgorGEgor/HW10.2/blob/main/haproxy-hw-1.cfg)
```bash
global
	log /dev/log	local0
...
![png](https://github.com/EgorGEgor/HW10.2/blob/main/%D0%97%D0%B0%D0%B4%D0%B0%D0%BD%D0%B8%D0%B5%202.2.png)
